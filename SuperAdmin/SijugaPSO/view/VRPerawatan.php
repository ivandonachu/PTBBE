...
if ($tanggal_awal == $tanggal_akhir) {
    $table = mysqli_query($koneksi, "SELECT * FROM kas_kecil_pso WHERE tanggal = '$tanggal_awal' AND akun_kas = 'PERAWATAN & SPAREPART' AND no_polisi = '$no_polisi' ");
} else {

    $table = mysqli_query($koneksi, "SELECT * FROM kas_kecil_pso WHERE tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir' AND akun_kas = 'PERAWATAN & SPAREPART' AND no_polisi = '$no_polisi'");
}
...
<head>
    ...
    <title>RINCIAN PERAWATAN & SPAREPART KENDARAAN</title>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Posisi Halaman -->
                    <small class="m-0 font-weight-thin text-primary"><a href="DsSijugaPSO">Dashboard</a> <i style="color: grey;" class="fa fa-caret-right" aria-hidden="true"></i> <a style="color: grey;">RINCIAN PERAWATAN & SPAREPART KENDARAAN</a> </small>
                    <br>
                    <br>
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                            <h5 style="color: grey;">RINCIAN PERAWATAN & SPAREPART KENDARAAN <?= $no_polisi ?> </h5>
                        </div>
                        <!-- Card Body -->
