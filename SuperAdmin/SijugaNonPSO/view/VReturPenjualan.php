...
if ($tanggal_awal == $tanggal_akhir) {
    $table = mysqli_query($koneksi, "SELECT * FROM retur_penjualan a INNER JOIN customer b ON b.kode_customer=a.kode_customer WHERE tanggal = '$tanggal_awal'");
} else {

    $table = mysqli_query($koneksi, "SELECT * FROM retur_penjualan a INNER JOIN customer b ON b.kode_customer=a.kode_customer WHERE tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir'");
}
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Posisi Halaman -->
                    <small class="m-0 font-weight-thin text-primary"><a href="DsSijugaPSO">Dashboard</a> <i style="color: grey;" class="fa fa-caret-right" aria-hidden="true"></i> <a style="color: grey;">Retur Penjualan PSO</a> </small>
                    <br>
                    <br>
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div style="height: 980px;" class="card-body">
                            <div class="chart-area">
                                ...
                                <?php echo "<form  method='POST' action='VReturPenjualan' style='margin-bottom: 15px;'>" ?>
                                <div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div align="right">
                                            <button style="font-size: clamp(7px, 3vw, 15px); " type="button" class="btn btn-primary" data-toggle="modal" data-target="#input"> <i class="fas fa-plus-square mr-2"></i>Catat Retur</button> <br> <br>
                                        </div>
                                        <!-- Form Modal  -->
                                            ...
                                            <div class="modal-dialog modal-lg" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body" align="left">
                                                        <?php echo "<form action='../proses/IRetur?tanggal1=$tanggal_awal&tanggal2=$tanggal_akhir' enctype='multipart/form-data' method='POST'>";  ?>
                                    ...
                                    <table align="center" id="example" class="table-sm table-striped table-bordered  nowrap" style="width:100%">
                                        <thead>
                                            <tr>
                                                ...
                                                <th style="font-size: clamp(12px, 1vw, 12px); color: black;">Jumlah Retur 55KG</th>
                                                <th style="font-size: clamp(12px, 1vw, 12px); color: black;">Jumlah Retur 12KG</th>
                                                <th style="font-size: clamp(12px, 1vw, 12px); color: black;">Jumlah Retur 50KG</th>
                                        ...
                                        <tbody>
                                            ...
                                            <?php
                                            $no_urut = 0;
                                            $total_retur_penjualan_55kg = 0;
                                            $total_retur_penjualan_12kg = 0;
                                            $total_retur_penjualan_50kg = 0;
                                            ...
                                            while ($data = mysqli_fetch_array($table)) {
                                                ...
                                                $total_retur_penjualan_55kg = $total_retur_penjualan_55kg + $qty_55kg;
                                                $total_retur_penjualan_12kg = $total_retur_penjualan_12kg + $qty_12kg;
                                                $total_retur_penjualan_50kg = $total_retur_penjualan_50kg + $qty_50kg;
                                                $no_urut++;
                                                ...
                                                <button style=" font-size: clamp(7px, 1vw, 10px); color:black; " href="#" type="submit" class=" btn bg-warning mr-2 rounded" data-toggle="modal" data-target="#formedit<?php echo $data['no_retur']; ?>" data-toggle='tooltip' title='Edit Retur'>
                                                    <i class="fa-regular fa-pen-to-square"></i></button>
                                                <!-- Form EDIT DATA -->

                                                <div class="modal fade" id="formedit<?php echo $data['no_retur']; ?>" role="dialog" arialabelledby="modalLabel" aria-hidden="true">
                                                    <div class="modal-dialog modal-lg" role="document">
                                                        <div class="modal-content">
                                                            <div class="modal-header">
                                                            ...
                                                            <div class="modal-body">
                                                                <form action="../proses/ERetur" enctype="multipart/form-data" method="POST">
                                                                    ...
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-md-6">
                                                                            ...
                                                                            <select id="tokens2" name="kode_customer" class=" form-control" data-live-search="true">
                                                                                <option value=""></option>
                                                                                ...
                                                                                ?>
                                                                                    <option value="<?= $data3['kode_customer']; ?>" <?php echo ($dataSelect == $data3['nama_customer']) ? "selected" : "" ?>><?php echo $data3['nama_customer']; ?></option>
                                                                                <?php
                                                                                }
                                                                                ?>
                                                                            </select>
                                                ...
                                                <!-- Button Hapus -->
                                                <button style=" font-size: clamp(7px, 1vw, 10px); color:black;" href="#" type="submit" class=" btn btn-danger" data-toggle="modal" data-target="#PopUpHapus<?php echo $data['no_retur']; ?>" data-toggle='tooltip' title='Hapus Retur'>
                                                    <i style="font-size: clamp(7px, 1vw, 10px); color: black;" class="fa-solid fa-trash"></i></button>
                                                <div class="modal fade" id="PopUpHapus<?php echo $data['no_retur']; ?>" role="dialog" arialabelledby="modalLabel" aria-hidden="true">
                                                    <div class="modal-dialog" role="document">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                                <form action="../proses/DRetur" method="POST">
                                                ...
                                                <div class="row no-gutters align-items-center">
                                                    <div class="col mr-2">
                                                        <div class="text-xs font-weight-bold text-success text-uppercase mb-1">
                                                            Total Retur 5,5kg</div>
                                                        <div class="h5 mb-0 font-weight-bold text-gray-800"><?= $total_retur_penjualan_55kg ?></div>
                                                    </div>
                                                    <div class="col-auto">
                                                    </div>
                                                </div>
                                        ...
                                        <div class="card border-left-success shadow h-100 py-2">
                                            <div class="card-body">
                                                <div class="row no-gutters align-items-center">
                                                    <div class="col mr-2">
                                                        <div class="text-xs font-weight-bold text-success text-uppercase mb-1">
                                                            Total Retur 12kg</div>
                                                        <div class="h5 mb-0 font-weight-bold text-gray-800"><?= $total_retur_penjualan_12kg ?></div>
                                                    </div>
                                                    <div class="col-auto">
                                                    </div>
                                                </div>
                                        ...
                                        <div class="card border-left-success shadow h-100 py-2">
                                            <div class="card-body">
                                                <div class="row no-gutters align-items-center">
                                                    <div class="col mr-2">
                                                        <div class="text-xs font-weight-bold text-success text-uppercase mb-1">
                                                            Total Retur 50kg</div>
                                                        <div class="h5 mb-0 font-weight-bold text-gray-800"><?= $total_retur_penjualan_50kg ?></div>
                                                    </div>
                                                    <div class="col-auto">
                                                    </div>
                                                </div>
