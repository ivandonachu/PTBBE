        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Posisi Halaman -->
                    <small class="m-0 font-weight-thin text-primary"><a href="DsSijugaNonPSO">Dashboard</a> <i style="color: grey;" class="fa fa-caret-right" aria-hidden="true"></i> <a style="color: grey;">Kas Kecil</a> </small>
                    <br>
                    <br>
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-6">
                                                                ...
                                                                <select name="akun_kas" class="form-control" required="">
                                                                    <option>PENAMBAHAN SALDO</option>
                                                                    <option>BBM</option>
                                                                            ...
                                                                            <div class="row">
                                                                                ...
                                                                                <div class="col-md-6">
                                                                                    ...
                                                                                    <select name="akun_kas" class="form-control">
                                                                                        ...
                                                                                        <option <?php echo ($dataSelect == 'PENAMBAHAN SALDO') ? "selected" : "" ?>>PENAMBAHAN SALDO</option>
