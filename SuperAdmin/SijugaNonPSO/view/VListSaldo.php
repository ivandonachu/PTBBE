...
$table = mysqli_query($koneksi, "SELECT * FROM list_saldo");
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Posisi Halaman -->
                    <small class="m-0 font-weight-thin text-primary"><a href="DsSijugaNonPSO">Dashboard</a> <i style="color: grey;" class="fa fa-caret-right" aria-hidden="true"></i> <a style="color: grey;">List Saldo</a> </small>
                    <br>
                    <br>
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                            <h5 style="color: grey;">List Saldo</h5>
                        </div>
                        <!-- Card Body -->
                            ...
                            <div class="chart-area">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-2">
                                        ...
                                        <div align="right">
                                            <button style="font-size: clamp(7px, 3vw, 15px); " type="button" class="btn btn-primary" data-toggle="modal" data-target="#input"> <i class="fas fa-plus-square mr-2"></i>Tambah Saldo</button> <br> <br>
                                        </div>
                                        <!-- Form Modal  -->
                                            ...
                                            <div class="modal-dialog modal-lg" role="document">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h5 class="modal-title"> Form Tambah Saldo</h5>
                                                    ...
                                                    <div class="modal-body" align="left">
                                                        <?php echo "<form action='../proses/ISaldo' enctype='multipart/form-data' method='POST'>";  ?>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                ...
                                                                <input class="form-control form-control-sm" type="text" name="nama_saldo" required="">
                                                            </div>
                                                            <div class="col-md-6">
                                                                <label>Jumlah Saldo</label>
                                                                <input class="form-control form-control-sm" type="text" name="jumlah_saldo" required="">
                                                            </div>
                                                        </div>
                                ...
                                <div style="overflow-x: auto" ;>
                                    <table align="center" id="example" class="table-sm table-striped table-bordered  nowrap" style="width:100%">
                                        <thead>
                                            <tr>
                                                <th style="font-size: clamp(12px, 1vw, 12px); color: black;">Kode Saldo</th>
                                                <th style="font-size: clamp(12px, 1vw, 12px); color: black;">Nama Saldo</th>
                                                <th style="font-size: clamp(12px, 1vw, 12px); color: black;">Jumlah Saldo</th>
                                        ...
                                        <tbody>
                                            ...
                                            while ($data = mysqli_fetch_array($table)) {
                                                $kode_saldo = $data['kode_saldo'];
                                                $nama_saldo = $data['nama_saldo'];
                                                $jumlah_saldo = $data['jumlah_saldo'];


                                                echo "<tr>
                                                <td style='font-size: clamp(12px, 1vw, 12px); color: black;' >$kode_saldo</td>
                                                <td style='font-size: clamp(12px, 1vw, 12px); color: black;' >$nama_saldo</td>
                                                <td style='font-size: clamp(12px, 1vw, 12px); color: black;' >"; ?> <?= formatuang($jumlah_saldo); ?> <?php echo "</td>

                                                "; ?>
                                                <?php echo "<td style='font-size: clamp(12px, 1vw, 15px);'>"; ?>

                                                <button style=" font-size: clamp(7px, 1vw, 10px); color:black; " href="#" type="submit" class=" btn bg-warning mr-2 rounded" data-toggle="modal" data-target="#formedit<?php echo $data['kode_saldo']; ?>" data-toggle='tooltip' title='Edit Data Saldo'>
                                                    <i class="fa-regular fa-pen-to-square"></i></button>
                                                <!-- Form EDIT DATA -->

                                                <div class="modal fade" id="formedit<?php echo $data['kode_saldo']; ?>" role="dialog" arialabelledby="modalLabel" aria-hidden="true">
                                                    <div class="modal-dialog modal-lg" role="document">
                                                        <div class="modal-content">
                                                            <div class="modal-header">
                                                            ...
                                                            <div class="modal-body">
                                                                <form action="../proses/ESaldo" enctype="multipart/form-data" method="POST">

                                                                    <div class="row">
                                                                        <div class="col-md-4">
                                                                            <label>Kode Saldo</label>
                                                                            <input class="form-control form-control-sm" type="text" name="kode_saldo" value="<?= $kode_saldo; ?>" required="" disabled>
                                                                            <input type="hidden" name="kode_saldo" value="<?= $kode_saldo; ?>">
                                                                        </div>
                                                                        <div class="col-md-4">
                                                                            <label>Nama Saldo</label>
                                                                            <input class="form-control form-control-sm" type="text" name="nama_saldo" value="<?= $nama_saldo; ?>" required="" disabled>
                                                                            <input type="hidden" name="nama_saldo" value="<?= $nama_saldo; ?>">
                                                                        </div>
                                                                        <div class="col-md-4">
                                                                            <label>Jumlah Saldo</label>
                                                                            <input class="form-control form-control-sm" type="text" name="jumlah_saldo" value="<?= $jumlah_saldo; ?>" required="">
                                                                        </div>
                                                                    </div>
                                                ...
                                                <!-- Button Hapus -->
                                                <button style=" font-size: clamp(7px, 1vw, 10px); color:black;" href="#" type="submit" class=" btn btn-danger" data-toggle="modal" data-target="#PopUpHapus<?php echo $data['kode_saldo']; ?>" data-toggle='tooltip' title='Hapus Saldo'>
                                                    <i style="font-size: clamp(7px, 1vw, 10px); color: black;" class="fa-solid fa-trash"></i></button>
                                                <div class="modal fade" id="PopUpHapus<?php echo $data['kode_saldo']; ?>" role="dialog" arialabelledby="modalLabel" aria-hidden="true">
                                                    <div class="modal-dialog" role="document">
                                                        <div class="modal-content">
                                                            <div class="modal-header">
                                                                <h4 class="modal-title"> <b> Hapus Saldo </b> </h4>
                                                                <button type="button" class="close" data-dismiss="modal" aria-label="close">
                                                                    <span aria-hidden="true"> &times; </span>
                                                                </button>
                                                            </div>
                                                            ...
                                                            <div class="modal-body">
                                                                <form action="../proses/DSaldo" method="POST">
                                                                    <input type="hidden" name="kode_saldo" value="<?php echo $kode_saldo; ?>">
                                                                    <div class="form-group">
                                                                        <h6> Yakin Ingin Hapus Saldo <?php echo $data['nama_saldo']; ?> ? </h6>
                                                                    </div>
