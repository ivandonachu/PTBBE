...
if ($tanggal_awal == $tanggal_akhir) {
    $table = mysqli_query($koneksi, "SELECT * FROM retur_penjualan_pso a INNER JOIN customer b ON b.kode_customer=a.kode_customer WHERE tanggal = '$tanggal_awal'");
} else {

    $table = mysqli_query($koneksi, "SELECT * FROM retur_penjualan_pso a INNER JOIN customer b ON b.kode_customer=a.kode_customer WHERE tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir'");
}
...
<head>
    ...
    <title>Retur Penjualan PSO</title>
                                    ...
                                    <table align="center" id="example" class="table-sm table-striped table-bordered  nowrap" style="width:100%">
                                        <thead>
                                            <tr>
                                                ...
                                                <th style="font-size: clamp(12px, 1vw, 12px); color: black;">Jumlah Retur 3KG</th>
                                        ...
                                        <tbody>
                                            ...
                                            while ($data = mysqli_fetch_array($table)) {
                                                ...
                                                $total_retur_penjualan = $total_retur_penjualan + $qty_3kg;
                                                $no_urut++;
                                                ...
                                                <div class="row no-gutters align-items-center">
                                                    <div class="col mr-2">
                                                        <div class="text-xs font-weight-bold text-success text-uppercase mb-1">
                                                            Total Retur 3kg</div>
                                                        <div class="h5 mb-0 font-weight-bold text-gray-800"><?= $total_retur_penjualan ?></div>
                                                    </div>
                                                    <div class="col-auto">
                                                    </div>
                                                </div>
