...
$table = mysqli_query($koneksi, "SELECT * FROM list_kendaraan WHERE status_kendaraan = 'Non PSO' ");
...
<head>
    ...
    <title>Rekap Pengeluaran Bulanan Non PSO</title>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Posisi Halaman -->
                    <small class="m-0 font-weight-thin text-primary"><a href="DsAdmin">Dashboard</a> <i style="color: grey;" class="fa fa-caret-right" aria-hidden="true"></i> <a style="color: grey;">Rekap Pengeluaran Bulanan Non PSO</a> </small>
                    <br>
                    <br>
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                            <h5 style="color: grey;">Rekap Pengeluaran Bulanan Non PSO</h5>
                        </div>
                        <!-- Card Body -->
